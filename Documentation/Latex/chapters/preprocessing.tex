...
\subsection{Hot Vector for the Amenities}

\subsubsection{Data Cleaning and Reduction in the Amenities' Hot Vector}
...
\subsection{Dealing with Mission Fields}
...
Aggiungere colonne modificate e screenshots

\subsubsection{Dealing with lists}
